...
class Trainer(object):
    ...
    def train(self):
        train_examples = self.processor.get_train_examples(self.args.query_ids_file_path, self.args.trainset_dir)
...
if __name__ == "__main__":
    ...
    data_path = './data/tokenize/'
    parser = argparse.ArgumentParser()
    #parser.add_argument("--bert_model_path", type=str, default=model_path + "bert_model.ckpt", help="The path of bert_model") 
    parser.add_argument("--bert_model_path", type=str, default=model_path + "model.ckpt-360020", help="The path of bert_model") 
    parser.add_argument("--bert_config_path", type=str, default=model_path + "bert_config.json", help="The path of bert_config file") 
    parser.add_argument("--bert_vocab_path", type=str, default=model_path + "vocab.txt", help="The path of vocab.") 
    parser.add_argument("--output_dir", type=str, default='./rank_model', help="The path of checkpoint you want to save") 
    ...
    parser.add_argument("--query_ids_file_path", type=str, default=data_path + "train.query.json", help="It's a json file, the result of converting text to ids, and the format is {'qid': xx, 'input_ids': xx}")
    parser.add_argument("--trainset_dir", type=str, default=data_path + "trainset", help="The directory of trainset, which contains queryid, golden_id, a series of docids.")
    parser.add_argument("--corpus_ids_file_path", type=str, default=data_path + "corpus.json", help="Its format is the same as query_ids_file_path.") 
